...
# Adding/Enabling CommandLineArguments:
parser = ArgumentParser()
parser.add_argument('--Assignment_final', help='Enter the datastore absolute path.')
...
# API Endpoints
app.add_url_rule('/Asssignment_final/create', view_func=CreateData.as_view('create', db_path), methods=['POST'])
app.add_url_rule('/Asssignment_final/read', view_func=ReadData.as_view('read', db_path), methods=['GET'])
app.add_url_rule('/Asssignment_final/delete', view_func=DeleteData.as_view('delete', db_path), methods=['DELETE'])
